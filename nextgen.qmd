...
afterwork <- upcoming |> filter(tolower(event) == "bbs nextgen afterwork")
...
* organizes monthly community / networking lunches and after-work events (see the [LinkedIn posts](https://www.linkedin.com/company/bbs-next-generation/posts) for upcoming ones). `r I(ifelse(has_lunch, paste0("The next lunch will be at KLARA (Clarastrasse 13, 4058 Basel) from 12-13 CET on ", lunch$date, " - [RSVP here](", lunch$registration, ")."), ""))`
`r I(ifelse(has_lunch, paste0("The next after-work event will be at Markthalle (Steinentorberg 20, 4051 Basel) from 18:30 CET on ", afterwork$date, " - [RSVP here](", afterwork$registration, ")."), ""))`
